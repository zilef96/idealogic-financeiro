...
import { criarGrupoOrcamento } from "@/lib/repositories/orcamento-repository"
...
export async function POST(req: Request) {
  ...
  try { return NextResponse.json({ id: await criarGrupoOrcamento(parsed.data) }, { status: 201 }) }
  catch (e) { return handleApiError(e, "Falha ao criar categoria no plano.") }
}
